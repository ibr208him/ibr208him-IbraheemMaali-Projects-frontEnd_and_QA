...
/************************************************************************************ */
  ...
  const {idgd}=useParams();
const getUser=async ()=>{
  const {data}=await axios.get(`https://crud-users-gold.vercel.app/users/${cv}`);
  setUser(data.user);
...
<div className="container-fluid">
  ...
  <div className="mb-3 w-25 ">
    <input type="submit" className="form-control bg-warning" value="Update User"/>
  </div> 
